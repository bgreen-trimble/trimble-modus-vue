...
import { ref } from 'vue'
import { Slider, Button, Tabs, Tab } from '@/components'
  ...
  <div class="slider-showcase-container">
    ...
    <Tabs v-model:active="activeTab" class="mb-6">
      <Tab id="features" label="Features">
        <template #tab>Features</template>
        <div>
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto">
                <Slider v-model="temperatureValue" :min="15" :max="30" label="Temperature (°C)" showValue
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto">
                <Slider v-model="stepValue" :step="25" label="Volume" showValue />
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto">
                <Slider v-model="ticksValue" label="Progress" :ticks="true" showValue />
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto">
                <Slider v-model="customTicksValue" :min="0" :max="4" :step="1" :ticks="customTicks" label="Zoom level"
                  showValue />
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Small -->
                <div class="space-y-4">
                  <Slider v-model="sizesValue.small" size="small" label="Small Size" showValue />
                ...
                <!-- Medium (default) -->
                <div class="space-y-4">
                  <Slider v-model="sizesValue.medium" size="medium" label="Medium Size (Default)" showValue />
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <!-- Large -->
                <div class="space-y-4">
                  <Slider v-model="sizesValue.large" size="large" label="Large Size" showValue />
                  <p class="text-sm text-gray-600 dark:text-gray-400">
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto">
                <Slider v-model="disabledValue" disabled label="Disabled slider" showValue />
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
          ...
          <section class="showcase-section">
            ...
            <div class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg">
              <div class="max-w-lg mx-auto space-y-6">
                <div>
                  <Slider v-model="purpleSliderValue" label="Purple Theme" showValue class="custom-purple" />
                  <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Value: {{ purpleSliderValue }}
                  </p>
                </div>
                <div>
                  <Slider v-model="greenSliderValue" label="Green Theme" showValue class="custom-green" />
                  <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
            ...
            <div class="example-code mt-4 bg-gray-100 dark:bg-gray-800 p-4 rounded-md">
              <pre><code>&lt;style&gt;
          .custom-purple :deep(.tm-slider-track) {
          background-color: #f3e5f5; /* Track color (unfilled portion) */
          }

          .custom-purple :deep(.tm-slider-track-fill) {
          background-color: #9c27b0; /* Filled portion */
          }

          .custom-purple :deep(.tm-slider-input) {
          &::-webkit-slider-thumb {
          border-color: #9c27b0;
          &:active {
          ...
          .custom-green :deep(.tm-slider-track) {
          background-color: #e8f5e9; /* Track color (unfilled portion) */
          }

          .custom-green :deep(.tm-slider-track-fill) {
          background-color: #4caf50; /* Filled portion */
          }

          .custom-green :deep(.tm-slider-input) {
          &::-webkit-slider-thumb {
          border-color: #4caf50;
          &:active {
          ...
          <section class="showcase-section">
            ...
            <p class="tm-body mb-4">
              The Slider component includes built-in accessibility features for keyboard navigation and screen reader
              support.
            </p>
            <div
              class="example-card p-4 border border-tm-gray-2 dark:border-tm-gray-8 rounded-lg bg-blue-50 dark:bg-blue-900/20">
              <div class="space-y-4">
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Step factor to increment/decrement the
                    value.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Whether to show the current value next
                    to the
                    label.</td>
                </tr>
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">boolean</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">false</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">When set to true, disables the
                    component.</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Unique identifier for the slider input
                    element.</td>
                </tr>
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">string</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">undefined</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Accessible label for screen readers.
                    Falls
                    back to the label if not provided.</td>
                </tr>
                <tr>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">valueText</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">string</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">undefined</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Descriptive text for the value, used by
                    screen
                    readers.</td>
                </tr>
                <tr>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">ticks</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">boolean | { value: number, label?:
                    string }[]
                  </td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">false</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Enable tick marks on the slider track.
                    Can be
                    true for auto-generated ticks or an array of custom ticks with labels.</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Triggered when the slider value changes
                    during
                    dragging or keyboard interaction.</td>
                </tr>
                <tr>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">change</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">value: number</td>
                  <td class="border border-tm-gray-2 dark:border-tm-gray-8 p-3">Triggered when the slider handle is
                    released
                    after dragging or when keyboard interaction ends.</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <Tab id="theme" label="Theme">
        <template #tab>Theme</template>
        <div class="space-y-8">
          <h2 class="tm-h2 mb-4">CSS Variables</h2>
          <p class="tm-body mb-6">
            The Slider component uses the following CSS variables for theming, defined in the <code>slider.css</code>
            file.
